  ...
  return (
    <div className="space-y-6 animate-fade-up">
      <div className="space-y-1">
        ...
        <p className="text-sm text-muted-foreground">Sign in to your FlowForge workspace</p>
      </div>

      <form onSubmit={handleSubmit((d: any) => login(d))} className="space-y-4">
        ...
        <Button type="submit" className="w-full" loading={isPending} rightIcon={<ArrowRight className="h-4 w-4" />}>
          Sign in
        </Button>
      </form>
      ...
      <div className="grid grid-cols-2 gap-3">
        {[
          ...
          <Button key={label} variant="outline" type="button" className="w-full gap-2">
            {icon} {label}
          </Button>
        ))}
      </div>
